...
For most applications, the built-in [CloudWatch integration](/guide/observability) provides excellent observability without additional dependencies. Use AppSignal when you need advanced APM features, team-focused error triage, or integrated uptime monitoring.
:::
