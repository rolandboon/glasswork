...
export default withMermaid(defineConfig({
    title: 'Glasswork',
    description: 'A transparent, serverless-optimized web framework for building OpenAPI-compliant REST APIs.',
    ...
    themeConfig: {
        ...
        socialLinks: [
            { icon: 'github', link: 'https://github.com/rolandboon/glasswork' }
        ],
    ...
    head: [
        ...
        ['meta', { property: 'og:description', content: 'A transparent, serverless-optimized web framework' }],
    ]
}));
