...
const exportKeys = ['./core', './http', './auth', './list-query', './jobs', './email', './uploads', './observability', './ws', './node'];
...
if ('registerAuthCasl' in root || 'bootstrapWorker' in root || 'WebSocketGateway' in root) {
